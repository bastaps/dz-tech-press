...
export function exportJSON() {
  downloadBlob(new Blob([JSON.stringify(DATASET, null, 2)], { type: 'application/json' }), 'programme_77_7_la_formation_numerique_pour_tous_de_7_a_77_an_mpf60dxd.json');
  toast('JSON exporté');
}
...
export async function exportPDF() {
  ...
  try {
    ...
    pdf.save('programme_77_7_la_formation_numerique_pour_tous_de_7_a_77_an_mpf60dxd.pdf');
    toast('PDF exporté');
