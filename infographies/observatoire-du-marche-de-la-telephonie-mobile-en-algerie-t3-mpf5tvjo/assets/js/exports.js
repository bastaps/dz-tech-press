...
export function exportJSON() {
  downloadBlob(new Blob([JSON.stringify(DATASET, null, 2)], { type: 'application/json' }), 'observatoire_du_marche_de_la_telephonie_mobile_en_algerie_t3_mpf5tvjo.json');
  toast('JSON exporté');
}
...
export async function exportPDF() {
  ...
  try {
    ...
    pdf.save('observatoire_du_marche_de_la_telephonie_mobile_en_algerie_t3_mpf5tvjo.pdf');
    toast('PDF exporté');
